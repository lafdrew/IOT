...
function menuObject() {
	...
	var advanced_L1 =
		[
			...
			{title:'_wireless_2',page:'wireless_advanced.asp',img:'but_wireless_24'},
			
			//{title:'_wireless_5',page:'wireless2_wds.asp',img:'but_wireless_5'},
			{title:'_wireless_5',page:'wireless2_advanced.asp.asp',img:'but_wireless_5'},
	...
	var advanced_L2 = [
		...
		[
			...
			{title:'_sched',page:'adv_schedule.asp'},			{title:'_upload_firm',page:'adm_upload_firmware.asp'},
			{title:'_management',page:'adm_management.asp'},		{title:'help660',page:'adv_qos.asp'},		
			{title:'_wizard',page:'setup_wizard.asp'},		{title:'bd_DHCP',page:'internet_dhcpcliinfo.asp'}
		],
		//wireless 2.4GHz(2)
		[
			//{title:'help743',page:'wireless_wds.asp'},
			{title:'_advanced',page:'wireless_advanced.asp'},
		...
		//wireless 5GHz(3)
		[
			//{title:'help743',page:'wireless2_wds.asp'},
			{title:'_advanced',page:'wireless2_advanced.asp'},
...
//			,{title:'_media_server',page:'mediaserver.asp'}
		],
		//help(7)
		[
