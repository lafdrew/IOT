...
<head>
<title>TRENDNET | modelName | Advanced | FTP Server</title>
...
function user_cnt(){
	...
	for(var i =0 ; i< 25;i++)
	{
		var temp_ftpername = get_by_id("ftp_username"+i).value;
		if (temp_ftpername != "")
				User_cnt ++;
	}
}
	...
	function set_reservation(){
		...
		{
			ftpname = get_by_id("ftp_username"+ i).value ;
			ftppasswd = get_by_id("ftp_password"+ i).value;
			ftpperm = get_by_id("ftp_permission"+ i).value;
			...
			if(ftpname.length > 0 ){
				...
				DataArray[DataArray.length++] = new Data("0",ftpname,ftppasswd,ftpperm, i);
			}
...
set_checked("<!--# echo ftp_enable -->",get_by_name("ftp"));
set_checked("<!--# echo auth_enable -->",get_by_name("auth"));
set_checked("<!--# echo accwan_enable -->",get_by_name("accwan"));
...
$('#admin_name').val('<!--# echo ftp_admin_name -->');
$('#codeplang').val('<!--# echo ftp_codepage -->');
...
*/
		...
		obj.set_ccp_act('set');
		obj.add_param_event('ftpserver');
		obj.set_param_next_page('ftpserver.asp');

//		get_by_id("ftp_enable0").value = get_by_name("ftp").value;
//		get_by_id("ftp_admin_name").value = get_by_id("admin_name").value;

//		get_by_id("ftp_admin_pass").value = get_by_id("admin_passwd").value;

		if ($('#admin_passwd').val() != "WDB8WvbXdH")
			obj.add_param_arg('ftp_admin_pass',$('#admin_passwd').val());
		else
			obj.add_param_arg('ftp_admin_pass',get_by_id("ftp_admin_pass").value);

		obj.add_param_arg('ftp_admin_name',$('#admin_name').val());
...
*/
		...
		obj.add_param_arg('ftp_enable',get_checked_value(get_by_name("ftp")));
		obj.add_param_arg('auth_enable',get_checked_value(get_by_name("auth")));
		obj.add_param_arg('accwan_enable',get_checked_value(get_by_name("accwan")));
		obj.add_param_arg('ftp_codepage',$('#codeplang').val());
		//obj.add_param_arg('ftp_admin_name',get_checked_value(get_by_name("auth"));
		//obj.add_param_arg('ftp_admin_name',get_checked_value(get_by_name("accwan"));
		//get_by_id("dhcpd_enable").value = $('#codeplang').val();
		//obj.add_param_arg('ftp_codepage',$('#codeplang').val());
		//obj.get_config_obj();
		for(var i=0; i<DataArray.length; i++)
		{
			...
			obj.add_param_arg('ftp_username'+i,DataArray[i].Name);
			obj.add_param_arg('ftp_password'+i,DataArray[i].Passwd);
			obj.add_param_arg('ftp_permission'+i,DataArray[i].Permi);
			obj.add_param_arg('ftp_enable'+i,'1');
		}
	...
	{
		var obj = new ccpObject();
		//bj.set_param_url('get_set.ccp');
		//bj.add_param_event('CCP_SUB_WEBPAGE_APPLY');
...
*/
	...
	function setValueFtpEnable()
	{
		var chk_part = get_by_id("ftp_enable").value;
		$('input[name=ftp][value='+chk_part+']').attr('checked', true);

		var chk_part1 = get_by_id("auth_enable").value;
		$('input[name=auth][value='+chk_part1+']').attr('checked', true);

		var chk_part2 = get_by_id("accwan_enable").value;
		$('input[name=accwan][value='+chk_part2+']').attr('checked', true);
	}
$(function(){
...
<input type="hidden" id="ftp_admin_name" name="ftp_admin_name" value="<!--# echo ftp_admin_name -->">
<input type="hidden" id="ftp_admin_pass" name="ftp_admin_pass" value="<!--# echo ftp_admin_pass -->">
<input type="hidden" id="ftp_codepage" name="ftp_codepage" value="<!--# echo ftp_codepage -->">

<input type="hidden" id="ftp_username0" name="ftp_username0" value="<!--# echo ftp_username0 -->">
<input type="hidden" id="ftp_password0" name="ftp_password0" value="<!--# echo ftp_password0 -->">
<input type="hidden" id="ftp_permission0" name="ftp_permission0" value="<!--#echo ftp_permission0 -->">
<input type="hidden" id="ftp_enable0" name="ftp_enable0" value="<!--#echo ftp_enable0 -->">
<input type="hidden" id="ftp_username1" name="ftp_username1" value="<!--# echo ftp_username1 -->">
<input type="hidden" id="ftp_password1" name="ftp_password1" value="<!--# echo ftp_password1 -->">
<input type="hidden" id="ftp_permission1" name="ftp_permission1" value="<!--#echo ftp_permission1 -->">
<input type="hidden" id="ftp_username2" name="ftp_username2" value="<!--# echo ftp_username2 -->">
<input type="hidden" id="ftp_enable1" name="ftp_enable1" value="<!--#echo ftp_enable1 -->">
<input type="hidden" id="ftp_password2" name="ftp_password2" value="<!--# echo ftp_password2 -->">
<input type="hidden" id="ftp_permission2" name="ftp_permission2" value="<!--# echo ftp_permission2 -->">
<input type="hidden" id="ftp_enable2" name="ftp_enable2" value="<!--#echo ftp_enable2 -->">
<input type="hidden" id="ftp_username3" name="ftp_username3" value="<!--# echo ftp_username3 -->">
<input type="hidden" id="ftp_password3" name="ftp_password3" value="<!--# echo ftp_password3 -->">
<input type="hidden" id="ftp_permission3" name="ftp_permission3" value="<!--# echo ftp_permission3 -->">
<input type="hidden" id="ftp_enable3" name="ftp_enable3" value="<!--#echo ftp_enable3 -->">
<input type="hidden" id="ftp_username4" name="ftp_username4" value="<!--# echo ftp_username4 -->">
<input type="hidden" id="ftp_password4" name="ftp_password4" value="<!--# echo ftp_password4 -->">
<input type="hidden" id="ftp_permission4" name="ftp_permission4" value="<!--# echo ftp_permission4 -->">
<input type="hidden" id="ftp_enable4" name="ftp_enable4" value="<!--#echo ftp_enable4 -->">
<input type="hidden" id="ftp_username5" name="ftp_username5" value="<!--# echo ftp_username5 -->">
<input type="hidden" id="ftp_password5" name="ftp_password5" value="<!--# echo ftp_password5 -->">
<input type="hidden" id="ftp_permission5" name="ftp_permission5" value="<!--# echo ftp_permission5 -->">
<input type="hidden" id="ftp_enable5" name="ftp_enable5" value="<!--#echo ftp_enable5 -->">
<input type="hidden" id="ftp_username6" name="ftp_username6" value="<!--# echo ftp_username6 -->">
<input type="hidden" id="ftp_password6" name="ftp_password6" value="<!--# echo ftp_password6 -->">
<input type="hidden" id="ftp_permission6" name="ftp_permission6" value="<!--# echo ftp_permission6 -->">
<input type="hidden" id="ftp_enable6" name="ftp_enable6" value="<!--#echo ftp_enable6 -->">
<input type="hidden" id="ftp_username7" name="ftp_username7" value="<!--# echo ftp_username7 -->">
<input type="hidden" id="ftp_password7" name="ftp_password7" value="<!--# echo ftp_password7 -->">
<input type="hidden" id="ftp_permission7" name="ftp_permission7" value="<!--# echo ftp_permission7 -->">
<input type="hidden" id="ftp_enable7" name="ftp_enable7" value="<!--#echo ftp_enable7 -->">
<input type="hidden" id="ftp_username8" name="ftp_username8" value="<!--# echo ftp_username8 -->">
<input type="hidden" id="ftp_password8" name="ftp_password8" value="<!--# echo ftp_password8 -->">
<input type="hidden" id="ftp_permission8" name="ftp_permission8" value="<!--# echo ftp_permission8 -->">
<input type="hidden" id="ftp_enable8" name="ftp_enable8" value="<!--#echo ftp_enable8 -->">
<input type="hidden" id="ftp_username9" name="ftp_username9" value="<!--# echo ftp_username9 -->">
<input type="hidden" id="ftp_password9" name="ftp_password9" value="<!--# echo ftp_password9 -->">
<input type="hidden" id="ftp_permission9" name="ftp_permission9" value="<!--# echo ftp_permission9 -->">
<input type="hidden" id="ftp_enable9" name="ftp_enable9" value="<!--#echo ftp_enable9 -->">
<input type="hidden" id="ftp_username10" name="ftp_username10" value="<!--# echo ftp_username10 -->">
<input type="hidden" id="ftp_password10" name="ftp_password10" value="<!--# echo ftp_password10 -->">
<input type="hidden" id="ftp_permission10" name="ftp_permission10" value="<!--# echo ftp_permission10 -->">
<input type="hidden" id="ftp_enable10" name="ftp_enable10" value="<!--#echo ftp_enable10 -->">
<input type="hidden" id="ftp_username11" name="ftp_username11" value="<!--# echo ftp_username11 -->">
<input type="hidden" id="ftp_password11" name="ftp_password11" value="<!--# echo ftp_password11 -->">
<input type="hidden" id="ftp_permission11" name="ftp_permission11" value="<!--# echo ftp_permission11 -->">
<input type="hidden" id="ftp_enable11" name="ftp_enable11" value="<!--#echo ftp_enable11 -->">
<input type="hidden" id="ftp_username12" name="ftp_username12" value="<!--# echo ftp_username12 -->">
<input type="hidden" id="ftp_password12" name="ftp_password12" value="<!--# echo ftp_password12 -->">
<input type="hidden" id="ftp_permission12" name="ftp_permission12" value="<!--# echo ftp_permission12 -->">
<input type="hidden" id="ftp_enable12" name="ftp_enable12" value="<!--#echo ftp_enable12 -->">
<input type="hidden" id="ftp_username13" name="ftp_username13" value="<!--# echo ftp_username13 -->">
<input type="hidden" id="ftp_password13" name="ftp_password13" value="<!--# echo ftp_password13 -->">
<input type="hidden" id="ftp_permission13" name="ftp_permission13" value="<!--# echo ftp_permission13 -->">
<input type="hidden" id="ftp_enable13" name="ftp_enable13" value="<!--#echo ftp_enable13 -->">
<input type="hidden" id="ftp_username14" name="ftp_username14" value="<!--# echo ftp_username14 -->">
<input type="hidden" id="ftp_password14" name="ftp_password14" value="<!--# echo ftp_password14 -->">
<input type="hidden" id="ftp_permission14" name="ftp_permission14" value="<!--# echo ftp_permission14 -->">
<input type="hidden" id="ftp_enable14" name="ftp_enable14" value="<!--#echo ftp_enable14 -->">
<input type="hidden" id="ftp_username15" name="ftp_username15" value="<!--# echo ftp_username15 -->">
<input type="hidden" id="ftp_password15" name="ftp_password15" value="<!--# echo ftp_password15 -->">
<input type="hidden" id="ftp_permission15" name="ftp_permission15" value="<!--# echo ftp_permission15 -->">
<input type="hidden" id="ftp_enable15" name="ftp_enable15" value="<!--#echo ftp_enable15 -->">
<input type="hidden" id="ftp_username16" name="ftp_username16" value="<!--# echo ftp_username16 -->">
<input type="hidden" id="ftp_password16" name="ftp_password16" value="<!--# echo ftp_password16 -->">
<input type="hidden" id="ftp_permission16" name="ftp_permission16" value="<!--# echo ftp_permission16 -->">
<input type="hidden" id="ftp_enable16" name="ftp_enable16" value="<!--#echo ftp_enable16 -->">
<input type="hidden" id="ftp_username17" name="ftp_username17" value="<!--# echo ftp_username17 -->">
<input type="hidden" id="ftp_password17" name="ftp_password17" value="<!--# echo ftp_password17 -->">
<input type="hidden" id="ftp_permission17" name="ftp_permission17" value="<!--# echo ftp_permission17 -->">
<input type="hidden" id="ftp_enable17" name="ftp_enable17" value="<!--#echo ftp_enable17 -->">
<input type="hidden" id="ftp_username18" name="ftp_username18" value="<!--# echo ftp_username18 -->">
<input type="hidden" id="ftp_password18" name="ftp_password18" value="<!--# echo ftp_password18 -->">
<input type="hidden" id="ftp_permission18" name="ftp_permission18" value="<!--# echo ftp_permission18 -->">
<input type="hidden" id="ftp_enable18" name="ftp_enable18" value="<!--#echo ftp_enable18 -->">
<input type="hidden" id="ftp_username19" name="ftp_username19" value="<!--# echo ftp_username19 -->">
<input type="hidden" id="ftp_password19" name="ftp_password19" value="<!--# echo ftp_password19 -->">
<input type="hidden" id="ftp_permission19" name="ftp_permission19" value="<!--# echo ftp_permission19 -->">
<input type="hidden" id="ftp_enable19" name="ftp_enable19" value="<!--#echo ftp_enable19 -->">
<input type="hidden" id="ftp_username20" name="ftp_username20" value="<!--# echo ftp_username20 -->">
<input type="hidden" id="ftp_password20" name="ftp_password20" value="<!--# echo ftp_password20 -->">
<input type="hidden" id="ftp_permission20" name="ftp_permission20" value="<!--# echo ftp_permission20 -->">
<input type="hidden" id="ftp_enable20" name="ftp_enable20" value="<!--#echo ftp_enable20 -->">
<input type="hidden" id="ftp_username21" name="ftp_username21" value="<!--# echo ftp_username21 -->">
<input type="hidden" id="ftp_password21" name="ftp_password21" value="<!--# echo ftp_password21 -->">
<input type="hidden" id="ftp_permission21" name="ftp_permission21" value="<!--# echo ftp_permission21 -->">
<input type="hidden" id="ftp_enable21" name="ftp_enable21" value="<!--#echo ftp_enable21 -->">
<input type="hidden" id="ftp_username22" name="ftp_username22" value="<!--# echo ftp_username22 -->">
<input type="hidden" id="ftp_password22" name="ftp_password22" value="<!--# echo ftp_password22 -->">
<input type="hidden" id="ftp_permission22" name="ftp_permission22" value="<!--# echo ftp_permission22 -->">
<input type="hidden" id="ftp_enable22" name="ftp_enable22" value="<!--#echo ftp_enable22 -->">
<input type="hidden" id="ftp_username23" name="ftp_username23" value="<!--# echo ftp_username23 -->">
<input type="hidden" id="ftp_password23" name="ftp_password23" value="<!--# echo ftp_password23 -->">
<input type="hidden" id="ftp_permission23" name="ftp_permission23" value="<!--# echo ftp_permission23 -->">
<input type="hidden" id="ftp_enable23" name="ftp_enable23" value="<!--#echo ftp_enable23 -->">
<input type="hidden" id="ftp_username24" name="ftp_username24" value="<!--# echo ftp_username24 -->">
<input type="hidden" id="ftp_password24" name="ftp_password24" value="<!--# echo ftp_password24 -->">
<input type="hidden" id="ftp_permission24" name="ftp_permission24" value="<!--# echo ftp_permission24 -->">
<input type="hidden" id="ftp_enable24" name="ftp_enable24" value="<!--#echo ftp_enable24 -->">
...
<div class="box_tn">
	...
	<tr>
		...
		<td class="CR">
			<input type="hidden" id="ftp_enable" name="ftp_enable" value="<!--# echo ftp_enable -->">
	...
	<tr>
		...
		<td class="CR">
			<input type="hidden" id="auth_enable" name="auth_enable" value="<!--# echo auth_enable -->">
	...
	<tr>
		...
		<td class="CR"><input type="hidden" id="accwan_enable" name="accwan_enable" value="<!--# echo accwan_enable -->">
		...
		<table cellspacing="0" cellpadding="0" class="formarea">
			<tr align="center">
				<td colspan="2" class="btn_field">
					...
					<input type="reset" class="button_submit" id="btn_cancel" value="" onclick="window.location.reload()" />
