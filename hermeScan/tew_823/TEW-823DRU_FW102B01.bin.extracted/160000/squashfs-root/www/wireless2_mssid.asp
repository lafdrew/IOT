...
<title>TRENDNET | modelName | Wireless 5GHz | Multi-SSID</title>
...
<script type="text/javascript">
	...
	var security_vap2 = "<!--# echo wlan1_vap2_security -->";
	security_vap2 = security_vap2.split("_");
	var security_vap3 = "<!--# echo wlan1_vap3_security -->";
	...
	var wepCfg = {
		'infokey':           ['<!--# echo wlan1_vap2_wep_default_key -->', '<!--# echo wlan1_vap3_wep_default_key -->'],
		'infoAuthMode':      [security_vap2[1], security_vap3[1]],
		'key128':            [decode_to_html('<!--# echot wlan1_vap2_wep128_key_1 -->'), decode_to_html('<!--# echot wlan1_vap2_wep128_key_2 -->'),
		                      decode_to_html('<!--# echot wlan1_vap2_wep128_key_3 -->'), decode_to_html('<!--# echot wlan1_vap2_wep128_key_4 -->'),
		                      decode_to_html('<!--# echot wlan1_vap3_wep128_key_1 -->'), decode_to_html('<!--# echot wlan1_vap3_wep128_key_2 -->'),
		                      decode_to_html('<!--# echot wlan1_vap3_wep128_key_3 -->'), decode_to_html('<!--# echot wlan1_vap3_wep128_key_4 -->')
		                     ],
		'key64':             [decode_to_html('<!--# echot wlan1_vap2_wep64_key_1 -->'), decode_to_html('<!--# echot wlan1_vap2_wep64_key_2 -->'),
		                      decode_to_html('<!--# echot wlan1_vap2_wep64_key_3 -->'), decode_to_html('<!--# echot wlan1_vap2_wep64_key_4 -->'),
		                      decode_to_html('<!--# echot wlan1_vap3_wep64_key_1 -->'), decode_to_html('<!--# echot wlan1_vap3_wep64_key_2 -->'),
		                      decode_to_html('<!--# echot wlan1_vap3_wep64_key_3 -->'), decode_to_html('<!--# echot wlan1_vap3_wep64_key_4 -->')
		                     ],
		'keyType':           ['<!--# echo wlan1_vap2_wep_display_key_1 -->', '<!--# echo wlan1_vap2_wep_display_key_2 -->',
		                      '<!--# echo wlan1_vap2_wep_display_key_3 -->', '<!--# echo wlan1_vap2_wep_display_key_4 -->',
		                      '<!--# echo wlan1_vap3_wep_display_key_1 -->', '<!--# echo wlan1_vap3_wep_display_key_2 -->',
		                      '<!--# echo wlan1_vap3_wep_display_key_3 -->', '<!--# echo wlan1_vap3_wep_display_key_4 -->'
		                     ]
	};
	...
	var wpaCfg = {
		...
		'infoAuthMode':      [security_vap2[1], security_vap3[1]],
		'infoKeyup':         ['<!--# echo wlan1_vap2_gkey_rekey_time -->', '<!--# echo wlan1_vap3_gkey_rekey_time -->'],
		'encrMode':          ['<!--# echo wlan1_vap2_psk_cipher_type -->', '<!--# echo wlan1_vap3_psk_cipher_type -->'],	//c_type
		'pskKey':            [decode_to_html('<!--# echot wlan1_vap2_psk_pass_phrase -->'), decode_to_html('<!--# echot wlan1_vap3_psk_pass_phrase -->')]
	};

	var Dr_vap2 = '<!--# echo wlan1_vap2_eap_radius_server_0 -->';
	Dr_vap2 = Dr_vap2.split("/");
  var Dr_vap3 = '<!--# echo wlan1_vap3_eap_radius_server_0 -->';
  Dr_vap3 = Dr_vap3.split("/");	
	...
	var EapCfg ={
		...
		'cacheT':            ['<!--# echo wlan1_vap2_eap_reauth_period -->', '<!--# echo wlan1_vap3_eap_reauth_period -->']
	};
...
function check_apply()
{
	...
	obj.set_ccp_act('set');
	obj.add_param_event('wlan1_multi_ssid');
	obj.set_param_next_page('wireless2_mssid.asp');
	obj.add_param_arg('reboot_type', 'wireless');
	
	//Multi-SSID
	obj.add_param_arg('wlan1_vap2_ssid',urlencode($('#show_ssid_1').val()));
	obj.add_param_arg('wlan1_vap2_enable',($('#mssid_enable1').attr('checked')?1:0));
	obj.add_param_arg('wlan1_vap2_schedule',$('#ssid_schedule1 :selected').val());

	obj.add_param_arg('wlan1_vap3_ssid',urlencode($('#show_ssid_2').val()));
	obj.add_param_arg('wlan1_vap3_enable',($('#mssid_enable2').attr('checked')?1:0));
	obj.add_param_arg('wlan1_vap3_schedule',$('#ssid_schedule2 :selected').val());
	...
	if(security_mode == "Disable")
		obj.add_param_arg('wlan1_vap2_security','disable');
	else if(security_mode == "OPEN" || security_mode == "SHARED" ||security_mode == "WEPAUTO")//WEP_MODE
	{
		obj.add_param_arg('wlan1_vap2_wep_default_key',$('#wep_default_key').val());
		...
		**/	
		for(var i=1; i<=4; i++)
		{
			if ($('#WEP'+i+'Select').val() == 0)
				obj.add_param_arg('wlan1_vap2_wep_display_key_'+i, "hex");
			else
				obj.add_param_arg('wlan1_vap2_wep_display_key_'+i, "ascii");
			
			if($('#WEP'+i).val().length == 5 || $('#WEP'+i).val().length == 10)
			{
				security_wep_key_len = security_wep_key_len + '_64';
				obj.add_param_arg('wlan1_vap2_wep64_key_'+i,urlencode($('#WEP'+i).val()));
			}
			else
			{
				security_wep_key_len = security_wep_key_len + '_128';
				obj.add_param_arg('wlan1_vap2_wep128_key_'+i,urlencode($('#WEP'+i).val()));
			}
		}

		if(security_mode == "OPEN") {
			obj.add_param_arg('wlan1_vap2_security','wep_open' + security_wep_key_len);
			obj.add_param_arg('wlan1_vap2_security_wep','wep_open' + security_wep_key_len);
		} else if(security_mode == "SHARED") {
			obj.add_param_arg('wlan1_vap2_security','wep_share' + security_wep_key_len);
			obj.add_param_arg('wlan1_vap2_security_wep','wep_share' + security_wep_key_len);
		} else if(security_mode == "WEPAUTO") {
			obj.add_param_arg('wlan1_vap2_security','wep_auto' + security_wep_key_len);	
			obj.add_param_arg('wlan1_vap2_security_wep','wep_auto' + security_wep_key_len);	
		}
	}
	else
	{
		if(security_mode == "WPAPSK" || security_mode == "WPA2PSK" || security_mode == "WPAPSKWPA2PSK") //WPA_P
		{
			if(security_mode == "WPAPSKWPA2PSK")
				obj.add_param_arg('wlan1_vap2_security',"wpa2auto_psk");
			else if(security_mode == "WPA2PSK")
				obj.add_param_arg('wlan1_vap2_security',"wpa2_psk");
			else if(security_mode == "WPAPSK")
				obj.add_param_arg('wlan1_vap2_security',"wpa_psk");
			
			obj.add_param_arg('wpaInfo_AuthenticationMode_','1.'+idx+'.1.0',0);
			obj.add_param_arg('wlan1_vap2_psk_pass_phrase',$("#passphrase").val());
		}
		else if(security_mode == "WPA" || security_mode == "WPA2" || security_mode == "WPA1WPA2") //WPA_E
		{
			if(security_mode == "WPA1WPA2")
				obj.add_param_arg('wlan1_vap2_security',"wpa2auto_eap");
			else if(security_mode == "WPA2")
				obj.add_param_arg('wlan1_vap2_security',"wpa2_eap");
			else if(security_mode == "WPA")
				obj.add_param_arg('wlan1_vap2_security',"wpa_eap");
			
			obj.add_param_arg('wpaInfo_AuthenticationMode_','1.'+idx+'.1.0',1);
			
			obj.add_param_arg('wlan1_vap2_eap_radius_server_0',$("#RadiusServerIP").val()+'/'+$("#RadiusServerPort").val()+'/'+$("#RadiusServerSecret").val());
			...
			obj.add_param_arg('wlan1_vap2_eap_reauth_period',$('#PMKCachePeriod').val());
			//obj.add_param_arg('wpaEap_RadiusSessionTime_','1.'+idx+'.1.1',$('#RadiusServerSessionTimeout').val());
		}
		
		obj.add_param_arg('wlan1_vap2_psk_cipher_type', send_cipher_value());
		obj.add_param_arg('wlan1_vap2_gkey_rekey_time',$("#keyRenewalInterval").val());
	}
	/* security 5G MSSID2*/
	//check data
	if (checkData1() == false)
	...
	if(security_mode == "Disable")
		obj.add_param_arg('wlan1_vap3_security','disable');
	else if(security_mode == "OPEN" || security_mode == "SHARED" ||security_mode == "WEPAUTO")//WEP_MODE
	{
		obj.add_param_arg('wlan1_vap3_wep_default_key',$('#wep_default_key1').val());		
		var security_wep_key_len = '';
		/* 
		** Date:	2012-03-29
		** Author:	Pascal Pai
		...
		**/	
		for(var i=1; i<=4; i++)
		{
			if ($('#WEP'+i+'Select1').val() == 0)
				obj.add_param_arg('wlan1_vap3_wep_display_key_'+i, "hex");
			else
				obj.add_param_arg('wlan1_vap3_wep_display_key_'+i, "ascii");
			
			if($('#WEP'+i+'1').val().length == 5 || $('#WEP'+i+'1').val().length == 10)
			{
				security_wep_key_len = security_wep_key_len + '_64';
				obj.add_param_arg('wlan1_vap3_wep64_key_'+i,urlencode($('#WEP'+i+'1').val()));
			}
			else
			{				
				security_wep_key_len = security_wep_key_len + '_128';					
				obj.add_param_arg('wlan1_vap3_wep128_key_'+i,urlencode($('#WEP'+i+'1').val()));
			}
		}

		if(security_mode == "OPEN") {
			obj.add_param_arg('wlan1_vap3_security','wep_open' + security_wep_key_len);
			obj.add_param_arg('wlan1_vap3_security_wep','wep_open' + security_wep_key_len);
		} else if(security_mode == "SHARED") {
			obj.add_param_arg('wlan1_vap3_security','wep_share' + security_wep_key_len);
			obj.add_param_arg('wlan1_vap3_security_wep','wep_share' + security_wep_key_len);
		} else if(security_mode == "WEPAUTO") {
			obj.add_param_arg('wlan1_vap3_security','wep_auto' + security_wep_key_len);		
			obj.add_param_arg('wlan1_vap3_security_wep','wep_auto' + security_wep_key_len);		
		}
	}
	else
	{
		...
		{
			if(security_mode == "WPAPSKWPA2PSK")
				obj.add_param_arg('wlan1_vap3_security',"wpa2auto_psk");
			else if(security_mode == "WPA2PSK")
				obj.add_param_arg('wlan1_vap3_security',"wpa2_psk");
			else if(security_mode == "WPAPSK")
				obj.add_param_arg('wlan1_vap3_security',"wpa_psk");
			
			obj.add_param_arg('wpaInfo_AuthenticationMode_','1.'+idx+'.1.0',0);
			obj.add_param_arg('wlan1_vap3_psk_pass_phrase',$("#passphrase1").val());
		}
		else if(security_mode == "WPA" || security_mode == "WPA2" || security_mode == "WPA1WPA2") //WPA_E
		{
			if(security_mode == "WPA1WPA2")
				obj.add_param_arg('wlan1_vap3_security',"wpa2auto_eap");
			else if(security_mode == "WPA2")
				obj.add_param_arg('wlan1_vap3_security',"wpa2_eap");
			else if(security_mode == "WPA")
				obj.add_param_arg('wlan1_vap3_security',"wpa_eap");

			obj.add_param_arg('wpaInfo_AuthenticationMode_','1.'+idx+'.1.0',1);
			obj.add_param_arg('wlan1_vap3_eap_radius_server_0',$("#RadiusServerIP1").val()+'/'+$("#RadiusServerPort1").val()+'/'+$("#RadiusServerSecret1").val());
			...
			obj.add_param_arg('wlan1_vap3_eap_reauth_period',$('#PMKCachePeriod1').val());
			//obj.add_param_arg('wpaEap_RadiusSessionTime_','1.'+idx+'.1.1',$('#RadiusServerSessionTimeout1').val());
			
		}
		obj.add_param_arg('wlan1_vap3_psk_cipher_type', send_cipher_value_1());
		obj.add_param_arg('wlan1_vap3_gkey_rekey_time',$("#keyRenewalInterval1").val());
	}
...
{
	var val_en = '<!--# echo wlan1_vap2_enable -->';
	$('#mssid_enable1').attr('checked',val_en=='1');
	var val_en = '<!--# echo wlan1_vap3_enable -->';
...
{
	var val_sche = '<!--# echo wlan1_vap2_schedule -->';
	$('#ssid_schedule1').val(val_sche);
	var val_sche = '<!--# echo wlan1_vap3_schedule -->';
...
{
	var security = "<!--# echo wlan1_vap2_security_wep -->";
...
{
	var security = "<!--# echo wlan1_vap3_security_wep -->";
	var val = security.split("_");
	...
	if(wepCfg.infoAuthMode[index*4]=="share") //shared
...
function checkData()
{
	var dot11_mode_value = '<!--# echo wlan1_dot11_mode -->';
...
<div id="radioOnField" style="display: none;">
	<div class="box_tn">
		<div class="CT"><script>show_words('_lb_multi_ssid_1')</script> - <script>show_words('KR17');</script></div>
		...
		<tr>
			...
			<td class="CR">
				<input name="submit_SSID1" type="text" id="show_ssid_1" size="32" maxlength="32" value="<!--# echot wlan1_vap2_ssid -->" />
			</td>
		</tr>
		</table>
	</div>
	...
	<br/>
	<div class="box_tn">
		<div class="CT"><script>show_words('_lb_multi_ssid_2')</script> - <script>show_words('KR17');</script></div>
		<table cellspacing="0" cellpadding="0" class="formarea">
		<tr>
			<td class="CL"><script>show_words('_lb_radio_onoff')</script></td>
			<td class="CR">
		...
		<tr>
			<td class="CL"><script>show_words('_wmode_ssid');</script></td>
			<td class="CR">
				<input name="submit_SSID2" type="text" id="show_ssid_2" size="32" maxlength="32" value="<!--# echot wlan1_vap3_ssid -->">
			</td>
		</tr>
		</table>
	</div>
