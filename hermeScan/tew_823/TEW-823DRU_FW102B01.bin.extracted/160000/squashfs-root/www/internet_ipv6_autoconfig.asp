...
function onPageLoad(){
		var link_local ;
		var ipv6_advert_lifetime = get_by_id("ipv6_ra_adv_valid_lifetime_l_one").value;
...
//		set_checked(get_by_id("ipv6_dhcp_pd_enable_l").value, get_by_id("ipv6_dhcp_pd_lan"));
		set_selectIndex("<!--# echo ipv6_autoconfig_dns_enable -->", get_by_id("ipv6_dns_autoconfig_enable"));
...
function disable_ipv6_autoconfig_auto_dns(){
	    var fixIP = get_by_id("ipv6_dns_autoconfig_enable").value;
	    var is_disabled;
	    if (fixIP == "0"){
	    	is_disabled = true;
	    }else{
...
function send_request(){  
	...
	var adver_lifetime_obj = new varible_obj(get_by_id("ipv6_auto_adver_lifetime").value, adver_lifetime_msg , 1, 35791395, false);
...
//	get_by_id("ipv6_autoconfig_dns_enable").value = get_by_id("ipv6_dns_autoconfig_enable").value;
//	get_by_id("ipv6_wan_specify_dns").value= get_by_id("ipv6_autoconfig_dns_enable").value;

	//check DNS Address
	if(get_by_id("ipv6_dns_autoconfig_enable").value=="1"){
	...
	if((check_mode == 0 || check_mode == 1) && enable_autoconfig == 1){
   			...
   			if (!check_varible(adver_lifetime_obj)){
   		 	...
   		 	//set Advertisement Lifetime				 		
                        ...
                        //alert("1111  "+get_by_id("ipv6_ra_adv_valid_lifetime_l_one").value);
		...
		obj.set_ccp_act('set');
		obj.add_param_event('adv_ipv6_autoconfig');
		obj.set_param_next_page('adv_ipv6_autoconfig.asp');		
		
		obj.add_param_arg('ipv6_wan_proto',get_by_id("ipv6_wan_proto").value);
		obj.add_param_arg('ipv6_autoconfig_dns_enable',get_by_id("ipv6_dns_autoconfig_enable").value);
		...
		obj.add_param_arg('ipv6_autoconfig_primary_dns',get_by_id("ipv6_autoconfig_primary_dns").value);
		obj.add_param_arg('ipv6_autoconfig_secondary_dns',get_by_id("ipv6_autoconfig_secondary_dns").value);
		...
		obj.add_param_arg('ipv6_wan_specify_dns',get_by_id("ipv6_dns_autoconfig_enable").value);
		...
		obj.add_param_arg('ipv6_autoconfig_lan_ip',get_by_id("ipv6_autoconfig_lan_ip").value);
		obj.add_param_arg('ipv6_dhcpd_lifetime',get_by_id("ipv6_dhcpd_lifetime").value);

		obj.add_param_arg('ipv6_dhcp_pd_hint_prefix',get_by_id("ipv6_dhcp_pd_hint_prefix").value);
		obj.add_param_arg('ipv6_dhcp_pd_hint_length',get_by_id("ipv6_dhcp_pd_hint_length").value);
		obj.add_param_arg('ipv6_dhcp_pd_hint_pltime',get_by_id("ipv6_dhcp_pd_hint_pltime").value);
		obj.add_param_arg('ipv6_dhcp_pd_hint_vltime',get_by_id("ipv6_dhcp_pd_hint_vltime").value);
				...
				<tr>
					<td valign="top" style="width:650px;padding-left:10px;">
						...
						<div id="mainform">
							...
							<input type="hidden" id="ipv6_autoconfig_dns_enable" name="ipv6_autoconfig_dns_enable" value="<!--# echo ipv6_autoconfig_dns_enable -->">
									...
									<tr>
										...
										<td class="CR">
											<select name="ipv6_w_proto" id="ipv6_w_proto" onChange=select_ipv6_wan_page(get_by_id("ipv6_w_proto").value);>
												...
												<option value="ipv6_autoconfig" selected><script>show_words('IPV6_TEXT107')</script></option>	<!--Autoconfiguration-->
						...
						<!--					<option value="2"><script>show_words('_help_txt84')</script></option>		DHCPv6(Stateful)-->
								...
								<div class="box_tn" id="dns_setting">	<!--Ipv6DNSServer-->
									...
									<tr id="DNSSelect_tr">
										...
										<td class="CR">
											<select name="ipv6_dns_autoconfig_enable" id="ipv6_dns_autoconfig_enable" size="1" onChange="disable_ipv6_autoconfig_auto_dns()">
									...
									<tr id="DnsPri_tr">
										...
										<td class="CR">
											<input type="text" id="ipv6_autoconfig_primary_dns" name="ipv6_autoconfig_primary_dns" size="45" maxlength="39" value="<!--# echo ipv6_autoconfig_primary_dns -->" />
										</td>
									</tr>
									<tr id="DnsSec_tr">
										<td class="CL"><script>show_words('_dns2')</script></td>
										<td class="CR">
											<input type="text" id="ipv6_autoconfig_secondary_dns" name="ipv6_autoconfig_secondary_dns" size="45" maxlength="39" value="<!--# echo ipv6_autoconfig_secondary_dns -->" />
										</td>
									</tr>
									</table>
								</div>
								...
								<div class="box_tn" id="lan_ip_setting">		<!--LanIpv6-->
									...
									<tr id="LanIpEnDhcpPD_tr">
										...
										<td class="CR">
											<input type="checkbox" id="ipv6_dhcp_pd_chk" name="ipv6_dhcp_pd_chk" value="1" onClick="disable_ipv6_dhcp_pd_chk();" />
										</td>
									</tr>
			...
			<td class="CR">&nbsp;<b>
				...
				<script>show_words('_minutes');</script><script>show_words('_optional');</script>
									...
									<tr id="LanIpAddr_tr">
										...
										<td class="CR">
											<input type="text" id="ipv6_autoconfig_lan_ip" name="ipv6_autoconfig_lan_ip" size="45" maxlength="63" value="<!--# echo ipv6_autoconfig_lan_ip -->" onChange="set_ipv6_autoconf_range()">
										</td>
									</tr>
								...
								<div class="box_tn" id="autoconf_setting">	<!--LanIPv6Auto-->
									...
									<tr id="show_router_advert_lifetime">
										...
										<td class="CR">
											<input type="text" id="ipv6_auto_adver_lifetime" name="ipv6_auto_adver_lifetime" size="20" maxlength="15" value="" />
											<script>show_words('_minutes')</script>
										</td>
									</tr>	
									</table>
