		...
		if(newIP!=''){
			...
			var ajax_param = {
				...
				error: function(xhr, ajaxOptions, thrownError){
					setTimeout(function(){is_page_work();}, 1500);
				}
			};
				...
				<tr>
					<td valign="top" style="width:650px;padding-left:10px;">
						...
						<tr>
							...
							<table border="0">
							<tr><td colspan="2"><script>show_words('_rebooting_plz_wait');</script></td></tr>
							<tr>
								<td>
								...
								<td><font color="white"><span id="progressValue">&nbsp;</span></font></td>
							</tr>
							</table>
