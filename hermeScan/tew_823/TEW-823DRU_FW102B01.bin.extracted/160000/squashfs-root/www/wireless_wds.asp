...
<script type="text/javascript">
	...
	var val = "<!--# echo wlan0_vap0_security -->";
	val = val.split("_");
	...
	var lanCfg = {
		...
		'sMode':      val[0],
		'sCipher':    val[1],
		'wdsenable':  '<!--# echo wlan0_wds_enable -->',
	};

	var wdsCfg = {
		'apmac':			['<!--# echo wlan0_wds_mac_1 -->','<!--# echo wlan0_wds_mac_2 -->','<!--# echo wlan0_wds_mac_3 -->','<!--# echo wlan0_wds_mac_4 -->'],
	};
	
	function check_value()
	{
			if(lanCfg.enabl == '1' && !check_is_open_wds())
			{
	...
	function check_apply()
	{
		...
		obj.add_param_arg('wlan0_wds_enable',wdsEnable);
		...
		for (var i = 1; i <= 4; i++) {
			...
			obj.add_param_arg('wlan0_wds_mac_' + i, mac_val.toUpperCase());
		}
	...
	{
		window.open("sitesurvey_24g.asp","scan","width=1000,height=500,resizable=1,scrollbars=1");
							...
							<div id="mainform">
								<!-- main content -->
									...
									<div class="header_desc" id="basicIntroduction">
										<script>show_words('_desc_wds')</script>
										<p></p>
									</div>
