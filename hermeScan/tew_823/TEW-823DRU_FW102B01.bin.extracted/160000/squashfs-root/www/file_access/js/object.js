var encoding_code = new Array("20", "22", "23", "24", "25", "26", "2B", "2C", "2F", "3A", "3B", "3C", "3D", "3E", "3F", "40", "5B", "5C", "5D", "5E", "60", "7B", "7C", "7D", "7E");
var encoding_char = new Array(' ', '"', '#', '$', '%', '&', '+', ',', '/', ':', ';', '<', '=', '>', '?', '@', '[', '\\', ']', '^', '`', '{', '|', '}', '~');
var url_encoding_char = new Array("-", "_", ".", "!", "~", "*", "'", "(", ")");
...
exec_cgi: function(para){
	...
	if (this.http_req){	
		...
		if (para.indexOf("get_webfile_info") != -1){	
...
exec_webfile_cgi: function(para){
	var req_url = "webfile_cgi.cgi?" + para;
	var obj = this;
