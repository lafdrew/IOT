...
*/
	...
	//	}
		...
		obj.add_param_arg('wan_mac',get_by_id("wan_mac").value);
                ...
                obj.add_param_arg('wan_pptp_russia_enable',1);
                obj.add_param_arg('wan_l2tp_russia_enable',0);
                        
		obj.set_param_url('apply.cgi');
		obj.set_ccp_act('set');
                obj.add_param_event('wan_rus_pptp');
		obj.set_param_next_page('internet_rus_wan_pptp.asp');
				...
				<tr>
					<td valign="top" style="width:650px;padding-left:10px;">
						...
						<div id="mainform">
							...
							<input type="hidden" id="wan_pptp_russia_enable" name="wan_pptp_russia_enable" value="1">
	...
	<tr>
		...
		<td class="CR">
			<select name="wan_proto" id="wan_proto" onChange="change_wan()">
				...
				<option value="rus_pptp"  selected>Russia PPTP</option>
