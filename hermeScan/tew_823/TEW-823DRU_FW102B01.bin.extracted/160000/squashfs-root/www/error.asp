...
<script type="text/javascript">
	...
	var error_message = "<!--# echo html_response_error_message -->";
...
<br>
<div id="box_header2">
	<div align="center" class="CELL" style="" id="cfg_failed">
		<div id="box_header2">
			<script>
				if (error_message=="rs_fail") {
					document.write("<p>");
					show_words('rs_intro_1');
					document.write("</p>");
					document.write("<p>");
					show_words('rs_intro_2');
					document.write("</p>");
				} else if (error_message=="hwid_fail") {
					document.write("<p>");
					show_words('ub_intro_1');
					document.write("</p>");
					document.write("<p>");
					show_words('ub_intro_3');
					document.write("</p>");
					document.write("<p>");
					show_words('ub_intro_2');
					document.write("</p>");
				} else {
			...
			<br>
			<input type="button" onclick="location.replace('<!--# echo html_response_return_page -->')" id="btn_err_cfg_failed" class="ButtonSmall" value="Back">
		</div>
	</div>
</div>
								</div>
