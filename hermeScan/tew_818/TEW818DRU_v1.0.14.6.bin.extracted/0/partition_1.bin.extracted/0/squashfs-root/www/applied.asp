...
<div class="hr" ></div>
<p>
<!--#tr id="applied.2"-->The new settings have been applied.<!--#endtr-->
</p>

<p>
<!--#tr id="applied.3"-->Press the button to continue configuring the router if the previous page is not restored<!--#endtr-->&nbsp;<span id="timeleft"></span>&nbsp;<!--#tr id="applied.4"-->seconds<!--#endtr-->.
</p>
<p>
<input type="button" class="button1" value="<!--#tr id="applied.continue"-->Continue<!--#endtr-->" onclick="go_continue();"/>
</p>
