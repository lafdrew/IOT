...
<form method="post" name ="SubmitLogEnable" action="/uapply.cgi" onsubmit="checkValue();" target="rebootRedirect">
...
<table width="100%" class="tbl_main">
	...
	<tr>
		...
		<td class="CR">
			<input type="checkbox" name="logEnabled" id="logEnabled" <% nvram_match("sysLogEnable", "1", "checked"); %> onkeydown="return prevent_press_enter(event);">
		</td>
	</tr>
	<tr>
...
<form method="link" name="ExportLog" action="/syslogdl.cgi">
<table width="100%" class="tbl_main">
	<tr>
		<td class="CT" colspan="2"><!--#tr id="syslg.3"-->Export Log<!--#endtr--></td>
	</tr>
	<tr>
		<td class="CL"><!--#tr id="sm.2"-->Export<!--#endtr--></td>
		<td class="CR"><input type="submit" class="button1" value="<!--#tr id="sm.2"-->Export<!--#endtr-->" name="ExportBtn" id="ExportBtn" Disabled></td>
	</tr>
</table>	
</form>								
...
<table width="100%" class="tbl_main">
	...
	<tr align="center">
		<td>
		<form method="post" name ="SubmitClearLog" action="/clearlog.cgi" target="rebootRedirect">
