...
<h1><!--#tr id="usb.node.eject.device"-->Eject Device<!--#endtr--></h1>
<div class="hr" ></div>
<p>
</p>

<form name="smb" method="post" action="/uapply.cgi" onSubmit="return applyCheck();" target="rebootRedirect">
<input type="hidden" name="page" value="/usb/ejectdevice.asp">
...
<table width="100%" class="tbl_main" style="display:none">
	...
	<tr id="wan_domain_tr">
		...
		<td class="CR"><input type="password" id="smbPasswordInput" name="smb_admin_pass" maxlength="15" value="<% nvram_get("smb_admin_pass"); %>"></td>
	</tr>
</table>
...
<table width="100%" class="tbl_main">
	<tr>
		<td class="CT" colspan="2"><!--#tr id="advanced.usb.device"-->USB Device<!--#endtr--></td>
	</tr>
	<tr>
		<td>
			<table width="100%" class="tbl_main2">
