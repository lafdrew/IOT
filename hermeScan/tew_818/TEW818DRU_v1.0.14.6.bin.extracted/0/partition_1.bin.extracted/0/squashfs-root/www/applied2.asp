...
<html lang="en"><!-- InstanceBegin template="/Templates/root_page.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
...
function page_load() {
	var projectName = "<% getProjectIdentity(); %>";
...
<div class="arrowlistmenu" style="padding-top: 0px">
	...
	<ul class="categoryitems">
		...
		<script>
		if (DosCotrolItme == "1")
			document.write("<li><a onclick=\"location.href='../advanced/dos.asp'\"><!--#tr id="adv.node.dos"-->DoS<!--#endtr--></a></li>");
		</script>
	</ul>
	...
	<ul class="categoryitems">
		...
		<li><a onclick="location.href='../usb/itunes_server.asp'"><!--#tr id="usb.node.itunes"-->iTunes Server<!--#endtr--></a></li>
		<li><a onclick="location.href='../usb/bt.asp'"><!--#tr id="usb.node.bt.client"-->BT Client<!--#endtr--></a></li>
...
<h1><!--#tr id="applied.1"-->Success<!--#endtr--></h1>
<div class="hr" ></div>
<p>
<!--#tr id="applied.5"-->The new settings have been saved.<!--#endtr-->
</p>

<p>
<!--#tr id="applied.6"-->The router must be rebooted before settings saved on a previous page will take effect. You can reboot the router now using the 'Reboot' button, or press the 'Continue' button and make other changes.<!--#endtr-->
</p>
<form method="post" id="SystemReboot" name="SystemReboot" action="/uapply.cgi" >
<p>
<input type="hidden" name="token" value="<% genToken(); %>">
<input name="action" type="submit" class="button1" style="width:130px;" value="<!--#tr id="applied.reboot"-->Reboot the Device<!--#endtr-->">
</p>
<p>
 	<input name="button" type="button" class="button1" style="width:130px;" onclick="go_continue();" value="<!--#tr id="applied.continue"-->Continue<!--#endtr-->"/>
</p>
</form>
