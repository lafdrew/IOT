...
<h1><!--#tr id="an.title"-->Advanced Network<!--#endtr--></h1>
<div class="hr" ></div>
<p>
<!--#tr id="an.desc"-->If you are not familiar with these Advanced Network settings, please read the help section before attempting to modify these settings.<!--#endtr-->
</p>

<form method="post" action="/uapply.cgi" onSubmit="return applyCheck();" target="rebootRedirect">
<input type="hidden" name="page" value="/adm/network.asp">
<input type="hidden" name="token" value="<% genToken(); %>">
<table width="100%" class="tbl_main">
	<tr>
		<td class="CT" colspan="2"><!--#tr id="an.1"-->UPnP<!--#endtr--></td>
	</tr>
	<tr>
		<td class="CL"
		onMouseOver="return overlib('Sets whether Universal Plug and Play (UPnP) is enabled.', LEFT);"
		onMouseOut="return nd();">
			<!--#tr id="an.1"-->UPnP<!--#endtr-->
		</td>
		<td class="CR">
			<select name="upnp_enable">
			  <option value="1" <% nvram_match("upnp_enable", "1", "selected"); %>><!--#tr id="enabled"-->Enabled<!--#endtr--></option>
			  <option value="0" <% nvram_match("upnp_enable", "0", "selected"); %>><!--#tr id="disabled"-->Disabled<!--#endtr--></option>
			</select>
		</td>
	</tr>  
</table>
...
<table width="100%" class="tbl_main">
	<tr>
		<td class="CT" colspan="2"><!--#tr id="an.2"-->WAN Ping<!--#endtr--></td>
	</tr>
	<tr>
		<td class="CL"
		onMouseOver="return overlib('Sets whether WAN Ping response is enabled.', LEFT);"
		onMouseOut="return nd();">
			<!--#tr id="an.3"-->WAN Ping Respond<!--#endtr-->
		</td>
		<td class="CR">
			<select name="icmp_enable">
			  <option value="1" <% nvram_match("icmp_enable", "1", "selected"); %>><!--#tr id="enabled"-->Enabled<!--#endtr--></option>
			  <option value="0" <% nvram_match("icmp_enable", "0", "selected"); %>><!--#tr id="disabled"-->Disabled<!--#endtr--></option>
			</select>
		</td>
	</tr>  
</table>
