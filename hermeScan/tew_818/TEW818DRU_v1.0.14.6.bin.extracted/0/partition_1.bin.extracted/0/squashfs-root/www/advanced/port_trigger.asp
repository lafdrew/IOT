...
<script type="text/javascript" src="../scripts/port_trigger.js"></script>
...
{
/*
    var TOTAL = document.getElementById("autofw_port").value;
    for (var i = 0; i < TOTAL; i++)
    {
        var matchStartPortElement = document.getElementById("autofw_port_out_start" + i);
        var matchEndPortElement = document.getElementById("autofw_port_out_end" + i);
        var triggerStartPortElement = document.getElementById("autofw_port_in_start" + i);
        var triggerEndPortElement = document.getElementById("autofw_port_in_end" + i); 
        
        // 1. If the values of the column in this row is all blank, it will pass the check.
        if (isBlankString(matchStartPortElement.value) && isBlankString(matchEndPortElement.value) &&  
            isBlankString(triggerStartPortElement.value) && isBlankString(triggerEndPortElement.value))
        {
            continue;
        }
        
        // 2. Check Ports
        if (!is_port_valid(matchStartPortElement.value))
        {
            matchStartPortElement.focus();
            Alert.render("<!--#tr id="port.error"-->Please input a correct port between 0 and 65535<!--#endtr-->");
            return false;
        }
        else if (!is_port_valid(matchEndPortElement.value))
        {
            matchEndPortElement.focus();
            Alert.render("<!--#tr id="port.error"-->Please input a correct port between 0 and 65535<!--#endtr-->");
            return false;
        }
        else if (!is_port_valid(triggerStartPortElement.value))
        {
            triggerStartPortElement.focus();
            Alert.render("<!--#tr id="port.error"-->Please input a correct port between 0 and 65535<!--#endtr-->");
            return false;
        }
        else if (!is_port_valid(triggerEndPortElement.value))
        {
            triggerEndPortElement.focus();
            Alert.render("<!--#tr id="port.error"-->Please input a correct port between 0 and 65535<!--#endtr-->");
            return false;
        }
        else if (parseInt(matchStartPortElement.value) > parseInt(matchEndPortElement.value))
        {
            matchStartPortElement.focus();
            Alert.render("<!--#tr id="trigger.alert.1"-->Match Start port should be less than Match End Port<!--#endtr-->");
            return false;
        } 
        else if (parseInt(triggerStartPortElement.value) > parseInt(triggerEndPortElement.value))
        {
            triggerStartPortElement.focus();
...
{
	if (document.pt.autofw_port_enable.options.selectedIndex == 1) {
...
<h1><!--#tr id="trigger.title"-->Port Trigger<!--#endtr--></h1>
<div class="hr" ></div>
<p>
<!--#tr id="trigger.desc"-->Automatically forward connections.<!--#endtr-->
</p>

<form method="post" name="pt" action="/uapply.cgi" onSubmit="return applyCheck();" target="rebootRedirect">
<input type="hidden" name="page" value="/advanced/port_trigger.asp">
<input type="hidden" name="token" value="<% genToken(); %>">
<table width="100%" class="tbl_main">
	<tr>
		<td class="CT" colspan="2"><!--#tr id="trigger.title"-->Port Trigger<!--#endtr--></td>
	</tr>
	<tr>
		<td class="CL"><!--#tr id="trigger.func"-->Port Trigger Function<!--#endtr--></td>
		<td class="CR">
		  <select id="autofw_port_enable" name="autofw_port_enable" onChange="updateState()">
			<option value="0" <% nvram_match("autofw_port_enable", "0", "selected"); %>><!--#tr id="disabled"-->Disabled<!--#endtr--></option>
			<option value="1" <% nvram_match("autofw_port_enable", "1", "selected"); %>><!--#tr id="enabled"-->Enabled<!--#endtr--></option>
		  </select>
		</td>
	</tr>
</table>
...
<table width="100%" class="tbl_main" id="rule_table" style="display:none">
	<tr>
		<td class="CT" colspan="2"><!--#tr id="trigger.add.rule"-->Add Port Trigger Rule<!--#endtr--></td>
	</tr>
	<tr>
		<td class="CL"><!--#tr id="enabled"-->Enable<!--#endtr--></td>
		<td class="CR">
			<input name="pt_rule_enable" type="checkbox" onkeydown="return prevent_press_enter(event);">
		</td>
	</tr>
	<tr>
		<td class="CL"><!--#tr id="match"-->Match<!--#endtr-->&nbsp;<!--#tr id="protocol"-->Protocol<!--#endtr--></td>
		<td class="CR">
			<select name="pt_match_proto">
				<option value="tcp" checked><!--#tr id="tcp"-->TCP<!--#endtr--></option>
				<option value="udp"><!--#tr id="udp"-->UDP<!--#endtr--></option>
				<option value="both"><!--#tr id="both"-->Both<!--#endtr--></option>
			</select>
		</td>
	</tr>
	<tr>
		<td class="CL"><!--#tr id="trigger.match.range"-->Match Port Range<!--#endtr--></td>
		<td class="CR">
			<input name="pt_match_port_start" value="" size="5" maxlength="5" onkeydown="return prevent_press_enter(event);">&nbsp;-&nbsp;<input name="pt_match_port_end" value="" size="5" maxlength="5" onkeydown="return prevent_press_enter(event);">	
		</td>
	</tr>
	<tr>
		<td class="CL"><!--#tr id="trigger"-->Trigger<!--#endtr--><br><!--#tr id="protocol"-->Protocol<!--#endtr--></td>
		<td class="CR">
			<select name="pt_trigger_proto">
				<option value="tcp" checked><!--#tr id="tcp"-->TCP<!--#endtr--></option>
				<option value="udp"><!--#tr id="udp"-->UDP<!--#endtr--></option>
				<option value="both"><!--#tr id="both"-->Both<!--#endtr--></option>
			</select>
	...
	<tr>
		<td class="CL"><!--#tr id="trigger.port.range"-->Trigger Port Range<!--#endtr--></td>
		<td class="CR">
			<input name="pt_trigger_port_start" value="" size="5" maxlength="5" onkeydown="return prevent_press_enter(event);">&nbsp;-&nbsp;<input name="pt_trigger_port_end" value="" size="5" maxlength="5" onkeydown="return prevent_press_enter(event);">	
		</td>
	</tr>
	<tr>
		<td class="CL"><!--#tr id="schedule"-->Schedule<!--#endtr--></td>
		<td class="CR">
			<select name="pt_sched">
...
<table width="100%" class="tbl_main" id="display_table" style="display:none">
	<tr>
		<td class="CT" colspan="2"><!--#tr id="trigger.rules"-->Port Trigger Rules<!--#endtr--></td>
	</tr>
	<tr>
		<td>
			<table width="100%" class="tbl_main2" id="tableList">
				<tbody>
					<tr>
						...
						<td class="form_list_title"><!--#tr id="match"-->Match<!--#endtr--><br><!--#tr id="protocol"-->Protocol<!--#endtr--></td>
						<td class="form_list_title" colspan="3"><!--#tr id="trigger.match.range"-->Match Port Range<!--#endtr--></td>
						<td class="form_list_title"><!--#tr id="trigger"-->Trigger<!--#endtr--><br><!--#tr id="protocol"-->Protocol<!--#endtr--></td>
						<td class="form_list_title" colspan="3"><!--#tr id="trigger.port.range"-->Trigger Port Range<!--#endtr--></td>
