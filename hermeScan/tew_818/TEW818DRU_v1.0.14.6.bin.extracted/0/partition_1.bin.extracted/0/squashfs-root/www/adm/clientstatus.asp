...
<h1><!--#tr id="adm.node.clientstatus"-->Client Status<!--#endtr--></h1>
<div class="hr" ></div>
<p>
<!--#tr id="adm.node.client.desc"-->This section allows you to monitor wired and wireless client devices that are currently connected to your router.<!--#endtr-->
</p>

<!-- ================= Clients Connection Information ================= -->
<form>
	<table width="100%" class="tbl_main">
		<tr>
			<td class="CT" colspan="2"><!--#tr id="client.wired.status"-->Wired Connected Devices<!--#endtr--></td>
		</tr>
		<tr>
			<td>
				<table width="100%" class="tbl_main2" id="wiredtableList">
					<tr>
						<td class="form_list_title" id="wirednumber">#</td>
						...
						<td class="form_list_title"><!--#tr id="mg.11"-->Host Name<!--#endtr--></td>
					</tr>
					<% client_conn_list(1); %>
				</table>
			</td>
	...
	<table width="100%" class="tbl_main">
		<tr>
			<td class="CT" colspan="2"><!--#tr id="client.wireless.status24"-->2.4GHz Wireless Connected Devices<!--#endtr--></td>
		</tr>
		<tr>
			<td>
				<table width="100%" class="tbl_main2" id="tableList24">
					<tr>
						<td class="form_list_title" id="ssid24"><!--#tr id="client.ssid"-->SSID<!--#endtr--></td>
						<td class="form_list_title"><!--#tr id="ip.address"-->IP Address<!--#endtr--></td>
						<td class="form_list_title"><!--#tr id="mac.address"-->MAC Address<!--#endtr--></td>
						<td class="form_list_title"><!--#tr id="mg.11"-->Host Name<!--#endtr--></td>
						<td class="form_list_title"><!--#tr id="client.linkrate"-->Link Rate<!--#endtr--></td>
					</tr>
					<% client_conn_list(2); %>
				</table>
			</td>
	...
	<table width="100%" class="tbl_main" id="wi5g_1">
		<tr>
			<td class="CT" colspan="2"><!--#tr id="basic.status.wireless.status5g"-->5GHz Wireless Connected Devices<!--#endtr--></td>
		</tr>
		<tr>
			<td>
				<table width="100%" class="tbl_main2" id="tableList51">
					<tr>
							<td class="form_list_title" id="ssid51"><!--#tr id="client.ssid"-->SSID<!--#endtr--></td>
							<td class="form_list_title"><!--#tr id="ip.address"-->IP Address<!--#endtr--></td>
							<td class="form_list_title"><!--#tr id="mac.address"-->MAC Address<!--#endtr--></td>
							<td class="form_list_title"><!--#tr id="mg.11"-->Host Name<!--#endtr--></td>
							<td class="form_list_title"><!--#tr id="client.linkrate"-->Link Rate<!--#endtr--></td>
