...
<h1><!--#tr id="usb.node.mediaserver"-->Media Server<!--#endtr--></h1>
<div class="hr" ></div>
<p>
<!--#tr id="advanced.usb.ms.desc"-->Set up the media server.<!--#endtr-->
</p>

<!-- DLNA Server Configuration -->
<form name="dms" method="post" action="/uapply.cgi" onSubmit="return applyCheck();">
<input type="hidden" name="page" value="/usb/mediaserver.asp">
<input type="hidden" name="token" value="<% genToken(); %>">
<table width="100%" class="tbl_main">
	<tr>
		<td class="CT" colspan="2"><!--#tr id="file.share.dms"-->DLNA Server Information<!--#endtr--></td>
	</tr>
	<tr>
		<td class="CL"><!--#tr id="file.share.server.status"-->Server Status<!--#endtr--></td>
		<td class="CR">
		  <select id="serverStatusSelect" name="dms_enable">
			<option value="0" <% nvram_match("dms_enable", "0", "selected"); %>><!--#tr id="disabled"-->Disabled<!--#endtr--></option>
			<option value="1" <% nvram_match("dms_enable", "1", "selected"); %>><!--#tr id="enabled"-->Enabled<!--#endtr--></option>
		  </select>
		</td>
	</tr>
	<tr">
		<td class="CL"><!--#tr id="file.share.server.name"-->Server Name<!--#endtr--></td>
		<td class="CR"><input id="serverNameInput" name="dms_host" maxlength="15" value="<% nvram_get("dms_host"); %>"></td>
	</tr>
</table>
