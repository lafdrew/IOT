...
<script type="text/javascript" src="../scripts/access_control.js"></script>
...
{
	if (document.fc.filter_client_enable.options.selectedIndex == 1) {
...
<h1><!--#tr id="access.title"-->Access Control<!--#endtr--></h1>
<div class="hr" ></div>
<p>
<!--#tr id="access.desc"-->Filter packets from IP addresses destined to certain port ranges during the specified times.<!--#endtr-->
</p>

<form method="post" name="fc" action="/uapply.cgi" onSubmit="return applyCheck();" target="rebootRedirect">
<input type="hidden" name="page" value="/advanced/access_control.asp">
...
<table width="100%" class="tbl_main">
	<tr>
		<td class="CT" colspan="2"><!--#tr id="access.title"-->Access Control<!--#endtr--></td>
	</tr>
	<tr>
		<td class="CL"><!--#tr id="access.client.filters.func"-->LAN Client Filter Function<!--#endtr--></td>
		<td class="CR">
			<select id="filter_client_enable" name="filter_client_enable" onChange="updateState()">
				<option value="0" <% nvram_match("filter_client_enable", "0", "selected"); %>><!--#tr id="disabled"-->Disabled<!--#endtr--></option>
				<option value="1" <% nvram_match("filter_client_enable", "1", "selected"); %>><!--#tr id="enabled"-->Enabled<!--#endtr--></option>
			</select>
		</td>
	</tr>
	<tr style="display:none">
		<td class="CL"><!--#tr id="access.url.filters.func"-->Web URL Filter Function<!--#endtr--></td>
		<td class="CR">
...
<table width="100%" class="tbl_main" id="rule_table" style="display:none">
	<tr>
		<td class="CT" colspan="2"><!--#tr id="access.add.rule"-->Add Access Control Rule<!--#endtr--></td>
	</tr>
	<tr>
		<td class="CL"><!--#tr id="enabled"-->Enable<!--#endtr--></td>
		<td class="CR">
			<input name="fc_rule_enable" type="checkbox" onkeydown="return prevent_press_enter(event);">
		</td>
	</tr>
	<tr>
		<td class="CL"><!--#tr id="access.lan.ip.range"-->LAN IP Address Range<!--#endtr--></td>
		<td class="CR">
			<input name="fc_ip_start" value="" size="15" maxlength="15" onkeydown="return prevent_press_enter(event);">&nbsp;-&nbsp;<input name="fc_ip_end" value="" size="15" maxlength="15" onkeydown="return prevent_press_enter(event);">
		</td>
	</tr>
	<tr>
		<td class="CL"><!--#tr id="protocol"-->Protocol<!--#endtr--></td>
		<td class="CR">
			<select name="fc_proto">
	...
	<tr>
		<td class="CL"><!--#tr id="destination"-->Destination<!--#endtr-->&nbsp;<!--#tr id="port.range"-->Port Range<!--#endtr--></td>
		<td class="CR">
			<input name="fc_port_start" value="" size="5" maxlength="5" onkeydown="return prevent_press_enter(event);">&nbsp;-&nbsp;<input name="fc_port_end" value="" size="5" maxlength="5" onkeydown="return prevent_press_enter(event);">	
		</td>
	</tr>
	<tr>
		<td class="CL"><!--#tr id="schedule"-->Schedule<!--#endtr--></td>
		<td class="CR">
			<select name="fc_sched">
...
<table width="100%" class="tbl_main" id="display_table" style="display:none">
	<tr>
		<td class="CT" colspan="2"><!--#tr id="access.lan.client.filters"-->LAN Client Filter Rules<!--#endtr--></td>
	</tr>
	<tr>
		<td colspan="2">
			<table width="100%" class="tbl_main2" id="tableList">
				<tbody>
					<tr>
						...
						<td class="form_list_title" colspan="3"><!--#tr id="access.lan.ip.range"-->LAN IP Address Range<!--#endtr--></td>
						<td class="form_list_title"><!--#tr id="protocol"-->Protocol<!--#endtr--></td>
						<td class="form_list_title" colspan="3"><!--#tr id="destination"-->Destination<!--#endtr--><br><!--#tr id="port.range"-->Port Range<!--#endtr--></td>
...
<table width="100%" class="tbl_main" style="display:none">
	<tr>
		<td class="CT" colspan="2"><!--#tr id="access.url.filters"-->Web URL Filter Rules<!--#endtr--></td>
	</tr>
	<tr>
		<td colspan="2">
			<table width="100%" class="tbl_main2">
				<tr>
					...
					<td class="form_list_title" colspan="3"><!--#tr id="access.lan.ip.range"-->LAN IP Address Range<!--#endtr--></td>
					<td class="form_list_title"><!--#tr id="url"-->URL<!--#endtr--></td>
					<td class="form_list_title"><!--#tr id="schedule"-->Schedule<!--#endtr--></td>
					<td class="form_list_title"><!--#tr id="enabled"-->Enabled<!--#endtr--></td>
				</tr>
<!--				<% filter_url(0, 23); %> 		-->
